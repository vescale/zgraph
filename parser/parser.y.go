...
var (
	yyXLAT = map[int]int{
		...
		57432: 59,  // count (56x)
		57462: 60,  // decLit (56x)
		57458: 61,  // elementNumber (56x)
		57438: 62,  // extract (56x)
		57365: 63,  // falseKwd (56x)
		57459: 64,  // floor (56x)
		57460: 65,  // hasLabel (56x)
		57461: 66,  // id (56x)
		57450: 67,  // inDegree (56x)
		57423: 68,  // interval (56x)
		57451: 69,  // javaRegexpLike (56x)
		57452: 70,  // label (56x)
		...
		57449: 80,  // uppper (56x)
		57614: 81,  // VariableName (54x)
		57616: 82,  // VariableReference (54x)
		57583: 83,  // PropertyAccess (50x)
		57605: 84,  // StringLiteral (49x)
		57606: 85,  // Subquery (48x)
		57491: 86,  // Aggregation (47x)
		57494: 87,  // ArithmeticExpression (47x)
		57496: 88,  // BindVariable (47x)
		57497: 89,  // BooleanLiteral (47x)
		57498: 90,  // BracketedValueExpression (47x)
		57501: 91,  // CaseExpression (47x)
		57502: 92,  // CastSpecification (47x)
		57503: 93,  // CharacterSubstring (47x)
		57511: 94,  // DateLiteral (47x)
		57521: 95,  // ExistsPredicate (47x)
		57525: 96,  // ExtractFunction (47x)
		57530: 97,  // FunctionInvocation (47x)
		57531: 98,  // FunctionName (47x)
		57545: 99,  // InPredicate (47x)
		57550: 100, // IntervalLiteral (47x)
		57553: 101, // IsNotNullPredicate (47x)
		57554: 102, // IsNullPredicate (47x)
		57566: 103, // Literal (47x)
		57567: 104, // LogicalExpression (47x)
		57570: 105, // NotInPredicate (47x)
		57571: 106, // NumericLiteral (47x)
		57590: 107, // RelationalExpression (47x)
		57593: 108, // ScalarSubquery (47x)
		57594: 109, // SearchedCase (47x)
		57599: 110, // SimpleCase (47x)
		57604: 111, // StringConcat (47x)
		57607: 112, // TimeLiteral (47x)
		57608: 113, // TimestampLiteral (47x)
		57611: 114, // ValueExpression (47x)
		57392: 115, // where (40x)
		57381: 116, // on (22x)
		57472: 117, // paramMarker (18x)
		57483: 118, // reachIncomingRight (17x)
		57619: 119, // VertexPattern (17x)
		123:   120, // '{' (15x)
		57481: 121, // reachOutgoingRight (15x)
		57479: 122, // edgeIncomingRight (13x)
		57477: 123, // edgeOutgoingRight (11x)
		58:    124, // ':' (9x)
		57363: 125, // edge (9x)
		57478: 126, // edgeIncomingLeft (9x)
		57476: 127, // edgeOutgoingLeft (9x)
		57474: 128, // leftArrow (9x)
		57398: 129, // properties (9x)
		57475: 130, // rightArrow (9x)
		57391: 131, // vertex (9x)
		57437: 132, // distinct (8x)
		57514: 133, // DistinctOpt (8x)
		57613: 134, // VariableLengthPathPattern (8x)
		46:    135, // '.' (6x)
		124:   136, // '|' (6x)
		57576: 137, // PathPatternMacro (6x)
		57615: 138, // VariableNameOpt (6x)
		57624: 139, // WhereClauseOpt (6x)
		57522: 140, // ExpAsVar (5x)
		57536: 141, // GraphName (5x)
		57555: 142, // LabelName (5x)
		57577: 143, // PathPatternMacroList (5x)
		57578: 144, // PathPatternMacroOpt (5x)
		57482: 145, // reachIncomingLeft (5x)
		57480: 146, // reachOutgoingLeft (5x)
		57598: 147, // SelectStmt (5x)
		61:    148, // '=' (4x)
		125:   149, // '}' (4x)
		57416: 150, // all (4x)
		57417: 151, // any (4x)
		57396: 152, // between (4x)
		57529: 153, // FromClause (4x)
		57540: 154, // GroupByClauseOpt (4x)
		57541: 155, // HavingClauseOpt (4x)
		57370: 156, // ifKwd (4x)
		57371: 157, // index (4x)
		57563: 158, // LimitClauseOpt (4x)
		57414: 159, // offset (4x)
		57573: 160, // OrderByClauseOpt (4x)
		57574: 161, // PathPattern (4x)
		57579: 162, // PatternQuantifier (4x)
		57580: 163, // PatternQuantifierOpt (4x)
		57386: 164, // set (4x)
		57600: 165, // SimplePathPattern (4x)
		57420: 166, // top (4x)
		57618: 167, // VariableSpec (4x)
		57622: 168, // WhenClause (4x)
		57499: 169, // ByItem (3x)
		57419: 170, // cheapest (3x)
		57504: 171, // ColonOrIsKeyword (3x)
		57517: 172, // EdgePattern (3x)
		57532: 173, // GraphElementInsertion (3x)
		57557: 174, // LabelPredicate (3x)
		57562: 175, // LengthNum (3x)
		57564: 176, // LimitOption (3x)
		57584: 177, // PropertyAssignment (3x)
		57586: 178, // PropertyName (3x)
		57418: 179, // shortest (3x)
		57473: 180, // allProp (2x)
		57404: 181, // begin (2x)
		57495: 182, // BeginStmt (2x)
		57356: 183, // by (2x)
		57500: 184, // ByList (2x)
		57405: 185, // commit (2x)
		57505: 186, // CommitStmt (2x)
		57357: 187, // create (2x)
		57508: 188, // CreateGraphStmt (2x)
		57509: 189, // CreateIndexStmt (2x)
		57410: 190, // day (2x)
		57513: 191, // DeleteStmt (2x)
		57362: 192, // drop (2x)
		57515: 193, // DropGraphStmt (2x)
		57516: 194, // DropIndexStmt (2x)
		57518: 195, // ElseClauseOpt (2x)
		57519: 196, // EmptyStmt (2x)
		57407: 197, // explain (2x)
		57523: 198, // ExplainStmt (2x)
		57415: 199, // graph (2x)
		57533: 200, // GraphElementInsertionList (2x)
		57534: 201, // GraphElementUpdate (2x)
		57424: 202, // hour (2x)
		57543: 203, // IfExists (2x)
		57544: 204, // IfNotExists (2x)
		57549: 205, // InsertStmt (2x)
		57374: 206, // into (2x)
		57551: 207, // IntoClause (2x)
		57552: 208, // IntoClauseOpt (2x)
		57546: 209, // InValueList (2x)
		57556: 210, // LabelNameList (2x)
		57561: 211, // LabelsAndProperties (2x)
		57559: 212, // LabelSpecification (2x)
		57560: 213, // LabelSpecificationOpt (2x)
		57378: 214, // match (2x)
		57568: 215, // MatchClause (2x)
		57425: 216, // minute (2x)
		57426: 217, // month (2x)
		57380: 218, // null (2x)
		57585: 219, // PropertyAssignmentList (2x)
		57413: 220, // rollback (2x)
		57591: 221, // RollbackStmt (2x)
		57427: 222, // second (2x)
		57595: 223, // SelectClause (2x)
		57596: 224, // SelectEelement (2x)
		57602: 225, // Statement (2x)
		57609: 226, // UpdateStmt (2x)
		57390: 227, // use (2x)
		57610: 228, // UseStmt (2x)
		57620: 229, // VertexPatternOpt (2x)
		57621: 230, // VertexReference (2x)
		57623: 231, // WhenClauseList (2x)
		57444: 232, // with (2x)
		57408: 233, // yearType (2x)
		57445: 234, // zone (2x)
		57492: 235, // AllPropertiesPrefixOpt (1x)
		57493: 236, // ArgumentList (1x)
		57406: 237, // booleanType (1x)
		57506: 238, // CostClause (1x)
		57507: 239, // CostClauseOpt (1x)
		57510: 240, // DataType (1x)
		57512: 241, // DateTimeField (1x)
		57361: 242, // doubleType (1x)
		57520: 243, // Entry (1x)
		57524: 244, // ExtractField (1x)
		57526: 245, // FieldAsName (1x)
		57527: 246, // FieldAsNameOpt (1x)
		57366: 247, // floatType (1x)
		57528: 248, // ForStringLengthOpt (1x)
		57535: 249, // GraphElementUpdateList (1x)
		57537: 250, // GraphOnClause (1x)
		57538: 251, // GraphOnClauseOpt (1x)
		57539: 252, // GraphPattern (1x)
		57547: 253, // IndexKeyTypeOpt (1x)
		57373: 254, // integerType (1x)
		57375: 255, // intType (1x)
		57558: 256, // LabelPredicateOpt (1x)
		57565: 257, // ListaggSeparatorOpt (1x)
		57442: 258, // long (1x)
		57569: 259, // MatchClauseList (1x)
		57572: 260, // Order (1x)
		57575: 261, // PathPatternList (1x)
		57447: 262, // prefix (1x)
		57581: 263, // PropertiesSpecification (1x)
		57582: 264, // PropertiesSpecificationOpt (1x)
		57587: 265, // PropertyNameList (1x)
		57588: 266, // QuantifiedPathExpr (1x)
		57589: 267, // ReachabilityPathExpr (1x)
		57592: 268, // RowsPerMatchOpt (1x)
		57597: 269, // SelectElementList (1x)
		57601: 270, // StartPosition (1x)
		57603: 271, // StatementList (1x)
		57443: 272, // stringKwd (1x)
		57439: 273, // timezoneHour (1x)
		57440: 274, // timezoneMinute (1x)
		57388: 275, // unique (1x)
		57612: 276, // ValueExpressionList (1x)
		57617: 277, // VariableReferenceList (1x)
		57490: 278, // $default (0x)
		38:    279, // '&' (0x)
		94:    280, // '^' (0x)
		126:   281, // '~' (0x)
		57351: 282, // andand (0x)
		...
		57484: 289, // empty (0x)
		57345: 290, // error (0x)
		57548: 291, // IndexName (0x)
		57350: 292, // invalid (0x)
		57485: 293, // lowerThanOn (0x)
		57488: 294, // mod (0x)
		57489: 295, // neg (0x)
		57469: 296, // neq (0x)
		57471: 297, // nulleq (0x)
		57486: 298, // pipesAsOr (0x)
