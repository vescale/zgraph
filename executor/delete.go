...
// DeleteExec represents the executor of DELETE statement.
...
func (e *DeleteExec) Next(ctx context.Context) (datum.Row, error) {
	if e.done {
		return nil, nil
	}
	e.done = true
	...
	if err != nil {
		logutil.Errorf(" vertices/edges failed: %+v", e.insertions)
	}

	return nil, err
}

func (e *DeleteExec) encodeInsertions(matchRow datum.Row) error {
...
func (e *DeleteExec) encodeInsertionsFromMatch(ctx context.Context) error {
	for {
...
func (e *DeleteExec) encodeVertex(graphID, vertexID int64, insertion *planner.ElementInsertion, matchRow datum.Row) error {
...
func (e *DeleteExec) encodeEdge(graphID int64, insertion *planner.ElementInsertion, matchRow datum.Row) error {
